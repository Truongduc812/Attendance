      ...
      try
      {
        ...
        //{
          ...
          result = queryable
                    ...
                    .FirstOrDefault();
          //result.Organization2s = result.Organization2s.Select(x => new Organization2Entity() { Id = x.Id, Name = x.Name }).ToList();
      ...
      try
      {
        ...
        if (result == null)
        {
          ...
          if (pagingReq != null)
          {
            ...
            // {
            //   Id = entity.Id,
            //   Organization2s = entity.Organization2s.Select(x => new Organization2Entity { Id = x.Id, Name = x.Name }).ToList()
            // })
...
/*[GEN-9]*/
    ...
    public override string GetDisplayField(OrganizationEntity entity)
    {
