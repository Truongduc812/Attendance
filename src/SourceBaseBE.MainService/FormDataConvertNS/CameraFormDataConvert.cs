...
//  public static partial class FormDataConvertCamera<TEntity> where TEntity : BaseCRUDEntity, new()
//  {
//    public static List<Dictionary<string, object>> GetFormDataObjElement(CameraEntity entity)
//    {
//      string category = nameof(CameraEntity);
//      List<Dictionary<string, object>> listRS = new List<Dictionary<string, object>>();

//      var properties = typeof(CameraEntity).GetProperties();
