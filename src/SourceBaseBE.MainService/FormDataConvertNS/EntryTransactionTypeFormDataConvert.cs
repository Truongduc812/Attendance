...
//  {
//    public static List<Dictionary<string, object>> GetFormDataObjElement(EntryTransactionTypeEntity entity)
//    {
//      string category = nameof(EntryTransactionTypeEntity);
//      List<Dictionary<string, object>> listRS = new List<Dictionary<string, object>>();

//      var properties = typeof(EntryTransactionTypeEntity).GetProperties();
