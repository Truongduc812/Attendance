...
//  public static partial class FormDataConvertComponentW<TEntity> where TEntity : BaseCRUDEntity, new()
//  {
//    public static List<Dictionary<string, object>> GetFormDataObjElement(ComponentWEntity entity)
//    {
//      string category = nameof(ComponentWEntity);
//      List<Dictionary<string, object>> listRS = new List<Dictionary<string, object>>();

//      var properties = typeof(ComponentWEntity).GetProperties();
