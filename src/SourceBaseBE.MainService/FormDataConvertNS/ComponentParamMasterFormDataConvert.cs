...
//  public static partial class FormDataConvertComponentParamMaster<TEntity> where TEntity : BaseCRUDEntity, new()
//  {
//    public static List<Dictionary<string, object>> GetFormDataObjElement(ComponentParamMasterEntity entity)
//    {
//      string category = nameof(ComponentParamMasterEntity);
//      List<Dictionary<string, object>> listRS = new List<Dictionary<string, object>>();

//      var properties = typeof(ComponentParamMasterEntity).GetProperties();
