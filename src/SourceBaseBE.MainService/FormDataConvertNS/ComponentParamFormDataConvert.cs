...
//  public static partial class FormDataConvertComponentParam<TEntity> where TEntity : BaseCRUDEntity, new()
//  {
//    public static List<Dictionary<string, object>> GetFormDataObjElement(ComponentParamEntity entity)
//    {
//      string category = nameof(ComponentParamEntity);
//      List<Dictionary<string, object>> listRS = new List<Dictionary<string, object>>();

//      var properties = typeof(ComponentParamEntity).GetProperties();
