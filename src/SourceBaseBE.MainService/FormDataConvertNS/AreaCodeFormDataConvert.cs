...
//  public static partial class FormDataConvertAreaCode<TEntity> where TEntity : BaseCRUDEntity, new()
//  {
//    public static List<Dictionary<string, object>> GetFormDataObjElement(AreaCodeEntity entity)
//    {
//      string category = nameof(AreaCodeEntity);
//      List<Dictionary<string, object>> listRS = new List<Dictionary<string, object>>();

//      var properties = typeof(AreaCodeEntity).GetProperties();
