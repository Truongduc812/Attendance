...
//  {
//    public static List<Dictionary<string, object>> GetFormDataObjElement(EntryRequestTypeEntity entity)
//    {
//      string category = nameof(EntryRequestTypeEntity);
//      List<Dictionary<string, object>> listRS = new List<Dictionary<string, object>>();

//      var properties = typeof(EntryRequestTypeEntity).GetProperties();
