...
//  public static partial class FormDataConvertComponentMaster<TEntity> where TEntity : BaseCRUDEntity, new()
//  {
//    public static List<Dictionary<string, object>> GetFormDataObjElement(ComponentMasterEntity entity)
//    {
//      string category = nameof(ComponentMasterEntity);
//      List<Dictionary<string, object>> listRS = new List<Dictionary<string, object>>();

//      var properties = typeof(ComponentMasterEntity).GetProperties();
