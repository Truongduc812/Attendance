...
//  {
//    public static List<Dictionary<string, object>> GetFormDataObjElement(GoodTypeEntity entity)
//    {
//      string category = nameof(GoodTypeEntity);
//      List<Dictionary<string, object>> listRS = new List<Dictionary<string, object>>();

//      var properties = typeof(GoodTypeEntity).GetProperties();
