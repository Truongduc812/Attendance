...
//  {
//    public static List<Dictionary<string, object>> GetFormDataObjElement(VehicleTypeEntity entity)
//    {
//      string category = nameof(VehicleTypeEntity);
//      List<Dictionary<string, object>> listRS = new List<Dictionary<string, object>>();

//      var properties = typeof(VehicleTypeEntity).GetProperties();
