...
//  {
//    public static List<Dictionary<string, object>> GetFormDataObjElement(PageMasterEntity entity)
//    {
//      string category = nameof(PageMasterEntity);
//      List<Dictionary<string, object>> listRS = new List<Dictionary<string, object>>();

//      var properties = typeof(PageMasterEntity).GetProperties();
