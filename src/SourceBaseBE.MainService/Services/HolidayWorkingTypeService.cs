...
{
  public class HolidayWorkingTypeService : BaseCRUDService<HolidayWorkingTypeEntity>
  {
    private UserRepository _authUserRepository;
    public HolidayWorkingTypeRepository _repositoryImp;
    
/*[GEN-1]*/

    public HolidayWorkingTypeService(CommonDBContext dbContext, ILogger<HolidayWorkingTypeService> logger)
      : base(dbContext, logger)
    {
      _repository = new HolidayWorkingTypeRepository(_dbContext);
      _repositoryImp = (HolidayWorkingTypeRepository)_repository;
...
/*[GEN-2]*/
    ...
    public override HolidayWorkingTypeEntity GetById(long id, bool isDirect = false, bool isTracking = true)
    {
      ...
      var entityRS = (HolidayWorkingTypeEntity)_authUserRepository.FillTrackingUser(entity);
      return entityRS;
    }
    ...
    public override List<HolidayWorkingTypeEntity> GetList(PagingRequestModel pagingReq = null)
    {
      ...
      var listRS = _authUserRepository.FillTrackingUser(list.Cast<BaseCRUDEntity>().ToList()).Cast<HolidayWorkingTypeEntity>().ToList();
      return listRS;
    }
    public override List<Dictionary<string, object>> GetFormDataObjElement(HolidayWorkingTypeEntity entity)
    {
      string entityName = nameof(HolidayWorkingTypeEntity);
      var listRS = new List<Dictionary<string, object>>();
      List<object> objectList = null;
      var properties = typeof(HolidayWorkingTypeEntity).GetProperties();
    ...
    /// <returns></returns>
    public override HolidayWorkingTypeEntity Upsert(HolidayWorkingTypeEntity entity, long? userId = null)
    {
      
/*[GEN-3]*/
      var upsertedEntity = ((HolidayWorkingTypeRepository)_repository).Upsert(entity/*[GEN-4]*/, userId);
      var entityRS = (HolidayWorkingTypeEntity)_authUserRepository.FillTrackingUser(upsertedEntity);
      return entityRS;
    }
    ...
    /// <returns></returns>
    private List<long> GetListIdChildren(HolidayWorkingTypeEntity entity, string childEntity)
    {
      switch (childEntity)
      {
...
/*[GEN-6]*/
    ...
    //public HolidayWorkingTypeEntity UpsertTestTransaction(HolidayWorkingTypeEntity entity, long? userId = null)
    //{
