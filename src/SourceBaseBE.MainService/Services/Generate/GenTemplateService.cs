...
{
  public class GenTemplateService : BaseCRUDService<GenTemplateEntity>
  {
    private UserRepository _userRepository;
    public GenTemplateRepository _repositoryImp;
    /*[GEN-1]*/

    public GenTemplateService(CommonDBContext dbContext, ILogger<GenTemplateService> logger)
      : base(dbContext, logger)
    {
      _repository = new GenTemplateRepository(_dbContext);
      _repositoryImp = (GenTemplateRepository)_repository;
    ...
    {
      /*[GEN-3]*/
      var upsertedEntity = ((GenTemplateRepository)_repository).Upsert(entity/*[GEN-4]*/, userId);
    ...
    /// <returns></returns>
    private List<long> GetListIdChildren(GenTemplateEntity entity, string childEntity)
    {
      switch (childEntity)
      {
    ...
    //public GenTemplateEntity UpsertTestTransaction(GenTemplateEntity entity, long? userId = null)
    //{
