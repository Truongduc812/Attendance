...
{
    public class TimeSheetApprovalService : BaseCRUDService<TimeSheetApprovalEntity>
    {
        private UserRepository _userRepository;
        public TimeSheetApprovalRepository _repositoryImp;

        /*[GEN-1]*/

        public TimeSheetApprovalService(CommonDBContext dbContext, ILogger<TimeSheetApprovalService> logger)
          : base(dbContext, logger)
        {
            _repository = new TimeSheetApprovalRepository(_dbContext);
            _repositoryImp = (TimeSheetApprovalRepository)_repository;
        ...
        public override TimeSheetApprovalEntity GetById(long id, bool isDirect = false, bool isTracking = true)
        {
            ...
            var entityRS = (TimeSheetApprovalEntity)_userRepository.FillTrackingUser(entity);
            return entityRS;
        }
        ...
        public override List<TimeSheetApprovalEntity> GetList(PagingRequestModel pagingReq = null)
        {
            ...
            var listRS = _userRepository.FillTrackingUser(list.Cast<BaseCRUDEntity>().ToList()).Cast<TimeSheetApprovalEntity>().ToList();
            return listRS;
        }
        public List<TimeSheetApprovalEntity> GetList(List<long>? ids)
        {
            var list = _repositoryImp.GetList(ids);
            return list;
        }
        public override List<Dictionary<string, object>> GetFormDataObjElement(TimeSheetApprovalEntity entity)
        {
            string entityName = nameof(TimeSheetApprovalEntity);
            var listRS = new List<Dictionary<string, object>>();
            List<object> objectList = null;
            var properties = typeof(TimeSheetApprovalEntity).GetProperties();
        ...
        /// <returns></returns>
        public override TimeSheetApprovalEntity Upsert(TimeSheetApprovalEntity entity, long? userId = null)
        {

            /*[GEN-3]*/
            var upsertedEntity = ((TimeSheetApprovalRepository)_repository).Upsert(entity/*[GEN-4]*/, userId);
            var entityRS = (TimeSheetApprovalEntity)_userRepository.FillTrackingUser(upsertedEntity);
            return entityRS;
        }
        ...
        public List<TimeSheetApprovalEntity> DeleteMulti(List<TimeSheetApprovalEntity> timeSheetApprovals, long? userId = null, bool isSoftDelete = true)
        {
        ...
        /// <returns></returns>
        private List<long> GetListIdChildren(TimeSheetApprovalEntity entity, string childEntity)
        {
            switch (childEntity)
            {
        ...
        //public TimeSheetApprovalEntity UpsertTestTransaction(TimeSheetApprovalEntity entity, long? userId = null)
        //{
